            ...
            output += `
                <div class="card card-body mb-2">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <span class="badge btn-primary">Stars: ${repo.stargazers_count}</span>
                            <span class="badge btn-secondary">Wachers: ${repo.watchers_count}</span>
                            <span class="badge btn-success">Forks: ${repo.forks_count}</span>
                        </div>
                    </div>
                </div>
            `;
